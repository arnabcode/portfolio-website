    ...
    <div className="intro-wrapper">
      ...
      <article className="intro-text">
        <p>
          ...
          specialised in React , Node and Java (Spring Boot). I car about
          building interfaces that are usable and pleasant along with backend
          which can be scaled and ar resilient to support dynamic content.
          <br />
          <br />
          ...
          in expected time with realistic targets , is another strength that I
          possess.
        </p>
        <br />
        <h3>Academics</h3>
